...
namespace WrathForged.Common.Cryptography
{
    ...
    public partial class SecureRemotePassword
    {
        ...
        public BigInteger ClientSessionKeyProof
        {
            ...
            {
                return
                    Hash(Hash(Modulus) ^ Hash(Generator), Hash(Username), Salt, PublicEphemeralValueA ?? new BigInteger(),
        ...
        {
            get { return Hash(PublicEphemeralValueA ?? new BigInteger(), ClientSessionKeyProof, SessionKey); }
        }
