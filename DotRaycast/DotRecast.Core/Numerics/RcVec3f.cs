...
public struct RcVec3f
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RcVec3f Subtract(RcVec3f left, RcVec3f right) => left - right;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RcVec3f Add(RcVec3f left, RcVec3f right) => left + right;

    public override bool Equals(object obj) => obj is RcVec3f && Equals((RcVec3f)obj);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(RcVec3f left, RcVec3f right) => left.Equals(right);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RcVec3f operator *(RcVec3f left, float right) => left * new RcVec3f(right);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RcVec3f operator *(float left, RcVec3f right) => right * left;
    ...
    {
        var d = 1.0f / MathF.Sqrt(RcMath.Sqr(v.X) + RcMath.Sqr(v.Y) + RcMath.Sqr(v.Z));
