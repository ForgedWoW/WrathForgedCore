...
public static class RcVecUtils
{
    ...
    public static float Get(this RcVec2f v, int i)
    {
        return i switch
        {
            0 => v.X,
            1 => v.Y,
            _ => throw new IndexOutOfRangeException("vector2f index out of range"),
        };
    }
    ...
    public static float Get(this RcVec3f v, int i)
    {
        return i switch
        {
            ...
            1 => v.Y,
            2 => v.Z,
            _ => throw new IndexOutOfRangeException("vector3f index out of range"),
        };
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RcVec3f Scale(this RcVec3f v, float scale) => v * scale;
    ...
    /// ignored.
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Perp2D(RcVec3f u, RcVec3f v) => (u.Z * v.X) - (u.X * v.Z);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsFinite(RcVec3f v) => float.IsFinite(v.X) && float.IsFinite(v.Y) && float.IsFinite(v.Z);

    /// Checks that the specified vector's 2D components are finite.
    /// @param[in] v A point. [(x, y, z)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsFinite2D(RcVec3f v) => float.IsFinite(v.X) && float.IsFinite(v.Z);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float PerpXZ(RcVec3f a, RcVec3f b) => (a.X * b.Z) - (a.Z * b.X);
