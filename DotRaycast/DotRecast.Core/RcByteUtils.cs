...
{
    public static int GetInt(byte[] data, int position, RcByteOrder order) => order == RcByteOrder.BIG_ENDIAN ? GetIntBE(data, position) : GetIntLE(data, position);
    ...
    public static int GetShort(byte[] data, int position, RcByteOrder order) => order == RcByteOrder.BIG_ENDIAN ? GetShortBE(data, position) : GetShortLE(data, position);

    public static int GetShortBE(byte[] data, int position) => ((data[position] & 0xff) << 8) | (data[position + 1] & 0xff);

    public static int GetShortLE(byte[] data, int position) => ((data[position + 1] & 0xff) << 8) | (data[position] & 0xff);
