...
public readonly struct DtStatus
{
    ...
    private DtStatus(uint value) => Value = value;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool IsEmpty() => 0 == Value;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Succeeded() => 0 != (Value & (DT_SUCCSESS.Value | DT_PARTIAL_RESULT.Value));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Failed() => 0 != (Value & (DT_FAILURE.Value | DT_INVALID_PARAM.Value));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool InProgress() => 0 != (Value & DT_IN_PROGRESS.Value);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool IsPartial() => 0 != (Value & DT_PARTIAL_RESULT.Value);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DtStatus operator |(DtStatus left, DtStatus right) => new(left.Value | right.Value);
