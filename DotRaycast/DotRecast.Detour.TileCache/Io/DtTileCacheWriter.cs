...
{
    public class DtTileCacheWriter(IDtTileCacheCompressorFactory compFactory) : DtWriter
    {
        ...
        private readonly IDtTileCacheCompressorFactory _compFactory = compFactory;
