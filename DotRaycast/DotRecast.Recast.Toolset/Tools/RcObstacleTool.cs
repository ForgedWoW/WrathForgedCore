...
{
    public class RcObstacleTool(IDtTileCacheCompressorFactory comp) : IRcToolable
    {
        private readonly IDtTileCacheCompressorFactory _comp = comp;
        private readonly DemoDtTileCacheMeshProcess _proc = new DemoDtTileCacheMeshProcess();
