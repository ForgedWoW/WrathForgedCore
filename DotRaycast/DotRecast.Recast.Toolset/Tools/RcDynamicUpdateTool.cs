...
{
    public class RcDynamicUpdateTool(Random rand, DemoInputGeomProvider bridgeGeom, DemoInputGeomProvider houseGeom, DemoInputGeomProvider convexGeom) : IRcToolable
    {
        private DtDynamicNavMesh dynaMesh;
        private readonly Dictionary<long, RcGizmo> colliderGizmos = new Dictionary<long, RcGizmo>();

        private readonly Random random = rand;
        private readonly DemoInputGeomProvider bridgeGeom = bridgeGeom;
        private readonly DemoInputGeomProvider houseGeom = houseGeom;
        private readonly DemoInputGeomProvider convexGeom = convexGeom;
