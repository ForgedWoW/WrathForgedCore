...
public class DtCylinderCollider(RcVec3f start, RcVec3f end, float radius, int area, float flagMergeThreshold) : DtCollider(area, flagMergeThreshold, Bounds(start, end, radius))
{
