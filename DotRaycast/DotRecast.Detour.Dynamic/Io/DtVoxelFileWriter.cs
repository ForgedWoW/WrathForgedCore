...
public class DtVoxelFileWriter(IRcCompressor compressor) : DtWriter
{
    private readonly IRcCompressor _compressor = compressor;

    public void Write(BinaryWriter stream, DtVoxelFile f, bool compression) => Write(stream, f, DtVoxelFile.PREFERRED_BYTE_ORDER, compression);
