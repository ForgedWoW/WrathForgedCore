...
public class DtDynamicNavMeshConfig(bool useTiles, int tileSizeX, int tileSizeZ, float cellSize)
{
    public readonly bool useTiles = useTiles;
    public readonly int tileSizeX = tileSizeX;
    public readonly int tileSizeZ = tileSizeZ;
