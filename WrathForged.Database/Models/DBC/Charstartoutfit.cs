    ...
    public DBCOutfit[] DBCOutfits
    {
        get
        {
            _dbcOutfits ??= new DBCOutfit[]
                {
                    new() { ItemId = ItemId1, DisplayItemId = DisplayItemId1, InventoryType = InventoryType1 },
                    new() { ItemId = ItemId2, DisplayItemId = DisplayItemId2, InventoryType = InventoryType2 },
                    new() { ItemId = ItemId3, DisplayItemId = DisplayItemId3, InventoryType = InventoryType3 },
                    new() { ItemId = ItemId4, DisplayItemId = DisplayItemId4, InventoryType = InventoryType4 },
                    new() { ItemId = ItemId5, DisplayItemId = DisplayItemId5, InventoryType = InventoryType5 },
                    new() { ItemId = ItemId6, DisplayItemId = DisplayItemId6, InventoryType = InventoryType6 },
                    new() { ItemId = ItemId7, DisplayItemId = DisplayItemId7, InventoryType = InventoryType7 },
                    new() { ItemId = ItemId8, DisplayItemId = DisplayItemId8, InventoryType = InventoryType8 },
                    new() { ItemId = ItemId9, DisplayItemId = DisplayItemId9, InventoryType = InventoryType9 },
                    new() { ItemId = ItemId10, DisplayItemId = DisplayItemId10, InventoryType = InventoryType10 },
                    new() { ItemId = ItemId11, DisplayItemId = DisplayItemId11, InventoryType = InventoryType11 },
                    new() { ItemId = ItemId12, DisplayItemId = DisplayItemId12, InventoryType = InventoryType12 },
                    new() { ItemId = ItemId13, DisplayItemId = DisplayItemId13, InventoryType = InventoryType13 },
                    new() { ItemId = ItemId14, DisplayItemId = DisplayItemId14, InventoryType = InventoryType14 },
                    new() { ItemId = ItemId15, DisplayItemId = DisplayItemId15, InventoryType = InventoryType15 },
                    new() { ItemId = ItemId16, DisplayItemId = DisplayItemId16, InventoryType = InventoryType16 },
                    new() { ItemId = ItemId17, DisplayItemId = DisplayItemId17, InventoryType = InventoryType17 },
                    new() { ItemId = ItemId18, DisplayItemId = DisplayItemId18, InventoryType = InventoryType18 },
                    new() { ItemId = ItemId19, DisplayItemId = DisplayItemId19, InventoryType = InventoryType19 },
                    new() { ItemId = ItemId20, DisplayItemId = DisplayItemId20, InventoryType = InventoryType20 },
                    new() { ItemId = ItemId21, DisplayItemId = DisplayItemId21, InventoryType = InventoryType21 },
                    new() { ItemId = ItemId22, DisplayItemId = DisplayItemId22, InventoryType = InventoryType22 },
                    new() { ItemId = ItemId23, DisplayItemId = DisplayItemId23, InventoryType = InventoryType23 },
                    new() { ItemId = ItemId24, DisplayItemId = DisplayItemId24, InventoryType = InventoryType24 }
                };
