...
"),
(28,"$min=$?s54825[${$m1/2}][${$m1}]
$max=$?s54825[${$M1/2}][${$M1}]"),
(29,"$junk=1"),
(30,"$total=${$m1*5}"),
(31,"$total=${$m1*5}"),
(61,"$mana=$?s55441[${$16191m1+1}][${$16191m1}]"),
(62,"$charges=$?s58673[${4+2}][${4}]"),
(63,"$dur1=$?s56801[${6+2+5}][${6+2}]
$dur2=$?s56801[${6+4+5}][${6+4}]
$dur3=$?s56801[${6+6+5}][${6+6}]
$dur4=$?s56801[${6+8+5}][${6+8}]
$dur5=$?s56801[${6+10+5}][${6+10}]"),
(64,"$bonus=$?s56807[${$m3*1.4}][${$m3}]"),
(81,"$weapon=$?s58657[${$m2*1.2}][${$m2}]
$bonus=$?s58657[${$m1*$m2/100*1.2}][${$m1*$m2/100}]"),
(82,"$absorb=$?s58635[${$m1*$AR*0.01*(100+$58635m1)*0.01}][${$m1*$AR*0.01}]"),
(83,"$percent=$?s56216[${$m1*(1+$56216m1/100)}][${$m1}]"),
(84,"$damage=$?s63333[${$m1*1.15}][${$m1}]
$healing=$?s63333[${$m1*1.15*1.5}][${$m1*1.5}]"),
(86,"$images=$?s63093[${$63093m1+$55342m2}][${$55342m2}]"),
(87,"$threat=$?s63326[${$m3*-1+$63326m1}][${$m3}]"),
(101,"$chance=$?s55439[${$m2+$55439m1}][${$m2}]"),
(102,"$bonus=${$m1*0.4}"),
(121,"$duration=$?s56846[${3}][${5}]
$mult=$?s56846[${4}][${2}]"),
(162,"$mult=$?s55673[${1.2}][${1}]"),
(164,"$glyph=$?s56810[${3}]$[${0}]
$mult1=$?s14165[${25}][${0}]
$mult=$?s14166[${50}][${$<mult1>}]"),
(165,"$dur=$?s54818[${8}][${6}]"),
(166,"$bonus=${$m1*0.5}"),
(167,"$arctic1=$?s31674[${1.01}][${1}]
...
"),
(172,"$opportunity1=$?s14057[${110}][${100}]
$percent=$?s14072[${120}][${$<opportunity1>}]"),
(175,"$tap1=$?s18182[${$18182m1*0.01+1}][${1}]
